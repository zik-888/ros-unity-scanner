...
namespace RootMotion.FinalIK {
	...
	public class IKSolverTrigonometric: IKSolver {
		...
		/// </summary>
		public static (Quaternion, Quaternion) Solve(Transform bone1, Transform bone2, Transform bone3, Vector3 targetPosition, Vector3 bendNormal, float weight) {
			if (weight <= 0f) return (Quaternion.identity, Quaternion.identity);
			...
			if (length == 0f) return (Quaternion.identity, Quaternion.identity);
