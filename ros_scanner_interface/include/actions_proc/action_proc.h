...
#include <ros_scanner_interface/ProcessingAction.h>
...
protected:
    ...
    //ros::NodeHandle nh;
    actionlib::SimpleActionServer<ros_scanner_interface::ProcessingAction> as_;
    // NodeHandle instance must be created before this line. Otherwise strange error occurs.
    std::string action_name_;
    // create messages that are used to published feedback/result
    ros_scanner_interface::ProcessingFeedback feedback_;
    ros_scanner_interface::ProcessingResult result_;
...
public:
  ...
  void executeCB(const ros_scanner_interface::ProcessingGoalConstPtr &goal, SPolyModel *scan_model) //, ros::NodeHandle &nh)
  {
