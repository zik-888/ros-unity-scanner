...
#include <ros_scanner_interface/StatusAction.h>
...
protected:
    //ros::NodeHandle nh;
    actionlib::SimpleActionServer<ros_scanner_interface::StatusAction> as_;
    // NodeHandle instance must be created before this line. Otherwise strange error occurs.
    std::string action_name_;
    // create messages that are used to published feedback/result
    ros_scanner_interface::StatusFeedback feedback_;
    ros_scanner_interface::StatusResult result_;
...
public:
  ...
  void executeCB(const ros_scanner_interface::StatusGoalConstPtr &goal) //, ros::NodeHandle &nh)
  {
      bool success = true;
      ros::Rate r(1);
